...
const DashboardHeader = ({ stats, userAvatar }) => {
    return (
        <header className="flex items-center justify-between px-6 py-6 sticky top-0 z-40 bg-[#050505]/80 backdrop-blur-md">
            {/* Brand - Volt Icon */}
            <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-volt rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(226,255,0,0.4)] relative overflow-hidden">
                    <div className="w-3 h-3 bg-black rounded-sm transform rotate-45 relative z-10"></div>
