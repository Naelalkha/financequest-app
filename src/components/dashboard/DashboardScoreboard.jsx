    ...
    return (
        <section className="px-6 pt-4 pb-12 relative z-20 animate-slide-up">
                ...
                <div className="flex justify-between items-start relative z-10">
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2 text-neutral-400">
                            <span className="font-mono text-[10px] tracking-[0.2em] uppercase">{t('dashboard.netImpactYTD')}</span>
            ...
            <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-full max-w-[70%] z-30">
                ...
                >
                    {isLoading ? (
                        <span className="font-mono text-xs animate-pulse">{t('dashboard.generating')}</span>
                    ) : (
                        <>
                            <Zap className="w-5 h-5 fill-current" />
                            {t('dashboard.startQuest')}
                        </>
                    )}
