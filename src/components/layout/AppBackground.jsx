    ...
    <div className={`fixed inset-0 overflow-hidden ${className}`}>
      ...
      <motion.div
        ...
        animate={{
          ...
          scale: mode === 'macro' ? 1 : 1.1 // Subtle zoom when fading out/in
        }}
      ...
      {/* Crosshair / dust texture for Micro Mode (Optional Polish) */}
      {mode === 'micro' && (
      ...
      {/* Global Vignette Effect - Darken edges (Always visible but enhanced in micro) */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: mode === 'micro'
            ? 'radial-gradient(circle at 50% 50%, transparent 40%, #000000 100%)' // Stronger vignette for focus
