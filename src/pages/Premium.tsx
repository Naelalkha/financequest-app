...
import SubscriptionManager from '../features/identity/components/SubscriptionManager';
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      ...
                      <div className="relative w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-500 rounded-2xl flex items-center justify-center shadow-glow-purple">
                        <RiVipCrownFill className="w-10 h-10 text-gray-900" />
                      </div>
                    </motion.div>
            ...
            <div className="inline-block mb-6">
              <div className="relative">
                <div className="relative flex items-center justify-center">
                  <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-purple-400 to-pink-500 rounded-3xl flex items-center justify-center">
                    <RiVipCrownFill className="w-16 h-16 sm:w-20 sm:h-20 text-gray-900" />
                  </div>
                </div>
              </div>
            </div>
