/**
 * ProtocolScreen - Phase 1: Briefing + Social Proof
 * 
 * Template pour l'écran de briefing
 * 
 * STRUCTURE:
 * 1. Zone Social Proof: Glass card avec asset 3D + carousel de stats
 * 2. Zone Tactiques: Timeline avec icônes Lucide + conseils actionnables
 * 3. CTA: Bouton pour lancer la mission
 * 
 * INSTRUCTIONS:
 * 1. Importer ton asset 3D dans le composant
 * 2. Adapter le texte de briefing
 * 3. Personnaliser les icônes de la timeline si besoin
 */
...
// [TODO: Importer ton asset 3D]
// import questAsset from '../../../../../assets/your-asset.png';

// [TODO: Importer les données depuis insightData.js]
import { socialProofSlides, proTips } from '../insightData';

// Icon mapping from insightData iconName to Lucide component
// [TODO: Ajouter d'autres icônes si nécessaire]
const ICON_MAP = {
    Search,
    Cog,
    ShieldAlert,
...
const ProtocolScreen = ({ onNext }) => {
    ...
    // [TODO: Personnaliser le texte de briefing]
    const briefingText = locale === 'fr'
        ? "Texte de briefing en français. Explique le problème et pourquoi cette quête est importante."
        : "Briefing text in English. Explain the problem and why this quest matters.";
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
                ...
                {/* ===== ZONE 1: SOCIAL PROOF INTEL (Glass Card) ===== */}
                <div className="p-6 relative">
                    ...
                    >
                        ...
                        {/* [TODO: 3D Asset Hero - Remplacer par ton asset] */}
                        {/* 
