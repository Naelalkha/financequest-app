...
import { ArrowRight, Zap, Wallet, Calculator, Target, LucideIcon } from 'lucide-react';
 ...
 * Page 0: Context - The problem + stats carousel
 * Page 1: Method - 3-step tactical timeline
 */
...
const ProtocolScreen: React.FC<ProtocolScreenProps> = ({ onNext, page, setPage }) => {
    ...
    const labels = {
        fr: {
            ...
            hook: "Tu gagnes de l'argent mais tu ne sais pas où il part.",
            hookHighlight: "Sans système, l'argent s'évapore.",
            statLabel: 'LES CHIFFRES',
            contextCta: 'VOIR LE PROTOCOLE',

            // Page 2
            methodCta: 'CALCULER MON BUDGET'
        },
        en: {
            hookLabel: 'THE PROBLEM',
            hook: "You earn money but don't know where it goes.",
            hookHighlight: "Without a system, money evaporates.",
            statLabel: 'THE NUMBERS',
            contextCta: 'SEE THE PROTOCOL',
            methodCta: 'CALCULATE MY BUDGET'
        }
    };
                            ...
                            <div className="flex flex-col gap-4 p-6 pt-2 pb-32">
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        {/* Hook quote */}
                                        <h3 className="font-sans font-semibold text-lg md:text-xl text-white leading-relaxed">
                                            "{L.hook}"
                                        </h3>
